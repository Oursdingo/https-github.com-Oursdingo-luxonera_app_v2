-- CreateEnum
CREATE TYPE "TestimonialType" AS ENUM ('TEXT', 'PHOTO', 'VIDEO', 'CONVERSATION');

-- CreateEnum
CREATE TYPE "Platform" AS ENUM ('WHATSAPP', 'INSTAGRAM', 'EMAIL');
...
CREATE TABLE "Product" (
    ...
    "lifestyleImages" TEXT[] DEFAULT ARRAY[]::TEXT[],
